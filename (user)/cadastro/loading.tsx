	...
	return (
		<div className="grid w-full animate-pulse place-items-center space-y-4 text-primary/10">
			...
			<div className="grid w-full gap-2">
				<p className="text-sm">
					(**) As opções "Masculino" e "Feminino" abrangem cisgêneros
					e transgêneros. A opção "outros" inclui gênero fluido,
					não-binário, queer, intersexo e outras identidades de
					gênero. Utilize a opção "não especificar" caso não queira
					preencher esse campo ou não encontre a opção que mais se
					identifica.
				</p>
