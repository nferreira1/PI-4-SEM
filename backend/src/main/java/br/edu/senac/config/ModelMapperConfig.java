...
public class ModelMapperConfig {
  ...
  public ModelMapper modelMapper() {
    ...
    Converter<Long, GeneroEntity> generoConverter =
        context -> {
    ...
    Converter<String, String> emailToLowerConverter =
        context -> {
    ...
    modelMapper
        ...
        .addMappings(
            mapper -> {
              mapper
                  .using(generoConverter)
                  .map(ClienteDTO::getGeneroId, ClienteEntity::setGeneroEntity);
              mapper
                  .using(emailToLowerConverter)
                  .map(ClienteDTO::getEmail, ClienteEntity::setEmail);
    ...
    modelMapper
        .typeMap(CarrinhoProdutosEntity.class, CarrinhoProdutosRequestDTO.class)
        .addMappings(
            mapper -> {
              ...
              mapper.map(
                  CarrinhoProdutosEntity::getQuantidade, CarrinhoProdutosRequestDTO::setQuantidade);
            });

    // Mapeamento de CarrinhoEntity para CarrinhoDTO
    modelMapper
        .typeMap(CarrinhoEntity.class, CarrinhoDTO.class)
        .addMappings(
            mapper -> {
