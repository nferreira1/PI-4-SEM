...
public class EnderecoController {
  ...
  public ResponseEntity<List<EnderecoDTO>> getByToken(
    ...
    var enderecosResponse =
        enderecosRequest.stream()
  ...
  @PreAuthorize("hasAuthority('CLIENTE')")
  public ResponseEntity<EnderecoDTO> post(
      JwtAuthenticationToken jwtAuthenticationToken, @RequestBody EnderecoDTO object) {
    var cliente =
        this.clienteService.findById(Long.valueOf(jwtAuthenticationToken.getToken().getSubject()));
    ...
    var enderecoResponse =
        this.modelMapper.map(this.enderecoService.insert(enderecoRequest), EnderecoDTO.class);
    URI uri =
        ServletUriComponentsBuilder.fromCurrentRequest()
            .path("/{id}")
            .buildAndExpand(enderecoRequest.getId())
            .toUri();
  ...
  @PreAuthorize("hasAuthority('CLIENTE')")
  public ResponseEntity<EnderecoDTO> put(
      JwtAuthenticationToken jwtAuthenticationToken,
      @RequestBody EnderecoDTO object,
    ...
    var enderecoResponse =
        this.modelMapper.map(
            this.enderecoService.update(enderecoId, enderecoRequest), EnderecoDTO.class);
  ...
  public ResponseEntity<EnderecoDTO> delete(
      JwtAuthenticationToken jwtAuthenticationToken, @PathVariable Long enderecoId) {
    var cliente =
        this.clienteService.findById(Long.valueOf(jwtAuthenticationToken.getToken().getSubject()));
  ...
  @PreAuthorize("hasAuthority('CLIENTE')")
  public ResponseEntity<EnderecoDTO> patch(
      JwtAuthenticationToken jwtAuthenticationToken, @PathVariable Long enderecoId) {
    var cliente =
        this.clienteService.findById(Long.valueOf(jwtAuthenticationToken.getToken().getSubject()));
    ...
    return ResponseEntity.ok()
        .body(modelMapper.map(this.enderecoService.update(enderecoId), EnderecoDTO.class));
  }
}
