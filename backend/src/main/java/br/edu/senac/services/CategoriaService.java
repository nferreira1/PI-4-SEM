...
@Service
public class CategoriaService extends ServiceGeneric<CategoriaEntity, Long>
    implements IServiceGeneric<CategoriaEntity, Long> {

  @Autowired private CategoriaRepository categoriarepository;

  @Autowired private ImageManagerService imageManagerService;
  ...
  public CategoriaEntity insert(CategoriaEntity object) {
    ...
    var urlImage =
        this.imageManagerService
            .insert(
                object.getImagem(), "/categorias", categoria.getId() + "-" + categoria.getNome())
            .orElseThrow(
                () ->
    ...
    var urlImage =
        this.imageManagerService
            .update(
                categoria.getImagem(),
                object.getImagem(),
                categoria.getId() + "-" + object.getNome())
            .orElseThrow(
                () ->
                    new ErrorResponseException(HttpStatus.BAD_REQUEST, "Erro ao salvar a imagem."));
