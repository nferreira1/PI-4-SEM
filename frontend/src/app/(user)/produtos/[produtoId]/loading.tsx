...
export default async function Loading() {
	return (
		<>
			<Skeleton className="relative flex h-[566px] items-center rounded-none md:col-span-1 md:rounded-lg lg:col-span-2" />
			<Skeleton className="md:col-span-1 md:rounded-lg lg:col-span-1" />
			...
			<section className="col-span-full animate-pulse px-5 py-6 pt-8 text-primary/10 md:hidden md:pb-0 md:pl-0">
				<div className="grid gap-2">
					...
					<Skeleton className="h-10 bg-primary/10 text-primary/10" />

					<Skeleton className="h-14" />
				</div>
			</section>

			<section className="col-span-full pb-6 pl-5 text-primary/10 md:pl-0">
